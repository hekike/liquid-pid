...
// Other variables
  ...
  this._Tf = options.Tf || false;               // Configure to true if using Fahrenheit
...
var toCelsius = function (tempF) {
  var fahrenheitFloat = parseFloat(tempF, 10);
  var celsiusTemp = (fahrenheitFloat - 32) * 5/9;
  var celsiusRounded = celsiusTemp.toFixed(10);
  return celsiusRounded;
};

PIDController.prototype.toFahrenheit = function (tempC) {
